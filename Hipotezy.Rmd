...
par(mfrow=c(1,2))
boxplot(as.numeric(dane$godziny_rozrywki_urzadzenia), main = "Liczba godzin spędzonych na \nkomputerze w celach rozrywkowych",ylab = "poziomy")
boxplot(as.numeric(dane$poczucie_uzaleznienia_urzadzenia), main = "Poczucie uzależnienia od urządzeń", ylab = "poziomy")
par(mfrow=c(1,1))
```
...
par(mfrow=c(1,2))
boxplot(as.numeric(dane$wyzn_pory_snu), main = "Posiadanie wyznaczonych pór snu",ylab = "poziomy")
boxplot(as.numeric(dane$jakosc_snu), main = "Jakość snu", ylab = "poziomy")
par(mfrow=c(1,1))
```
...
par(mfrow=c(1,2))
boxplot(as.numeric(dane$godziny_sportu), main = "Liczba godzin poświęcanych na sport",ylab = "poziomy")
