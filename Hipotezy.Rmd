...
#najciemniejszy kolor - nigdy nie odczuwa upokorzenia
#najjaśniejszy kolor - zawsze odczuwa upokorzenie
barplot(tab, xlab="Jakość snu", ylab="Rozkład poczucia upokorzenia", sub="Najciemniejszy kolor - nigdy nie odczuwa upokorzenia")
ttab <- prop.table(tab, margin = 2)*100
ttab # w procentach
barplot(ttab, xlab="Jakość snu", ylab="Procentowy rozkład poczucia upokorzenia", sub="Najciemniejszy kolor - nigdy nie odczuwa upokorzenia")
```


##Badamy zależność pomiędzy dietą a poczuciem radości
```{r}
cor.test(x = as.numeric(dane$dieta), y = as.numeric(dane$radosc),
         method = "spearman")$p.value
cor.test(x = as.numeric(dane$dieta), y = as.numeric(dane$radosc),
         method = "kendall")$p.value
```

Nie ma podstaw do odrzucenia $H_0$. Nie istnieje zależność pomiędzy dietą, a poczuciem radości.
...
tab #Tabela kontyngencji
#najciemniejszy kolor - dieta fast food
#najjaśniejszy kolor - zbilansowana dieta
barplot(tab, xlab="Poczucie radości", ylab="Rozkład rodzaju diety", sub="Najciemniejszy kolor - dieta fast food")
ttab <- prop.table(tab, margin = 2)*100
ttab # w procentach
barplot(ttab, xlab="Poczucie radości", ylab="Procentowy rozkład rodzaju diety", sub="Najciemniejszy kolor - dieta fast food")
```
