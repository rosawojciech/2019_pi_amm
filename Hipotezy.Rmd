...
barplot(tab,
        main = "Oddczuwanie upokorzenia w zależności od jakości snu",
        xlab="Jakość snu",
...
legend("topright",
       ...
       fill = c("yellow", "limegreen", "royalblue3", "purple", "mediumvioletred", "maroon1", "seashell1"),
       cex=0.9)
```
...
legend("topright",
       ...
       title = "Częstość",
       legend = c("nigdy", "b.rzadko", "rzadko", "czasami", "często", "b.często", "zawsze"),
       fill = c("lightyellow3", "antiquewhite1", "cyan3", "chartreuse", "darkorange1", "firebrick1", "darkorchid3"),
       cex=0.9)
ttab <- prop.table(tab, margin = 2)*100
ttab # w procentach
barplot(ttab,
...
legend("topright",
       ...
       fill = c("yellow", "limegreen", "royalblue3", "purple", "mediumvioletred"),
       cex=0.95)
ttab <- prop.table(tab, margin = 2)*100
ttab # w procentach
barplot(ttab,
