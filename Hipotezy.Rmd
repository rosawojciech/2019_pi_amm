...
barplot(ttab,
        ...
        names.arg = c("bardzo zła", "kiepska", "przeciętna", "dobra", "bardzo dobra"),
        legend.text = c("nigdy", "bardzo rzadko", "rzadko", "czasami", "często", "bardzo często", "zawsze"))
#legend(x=10, y=90, title = "Jak często odczuwasz upokorzenie?", legend = c("nigdy", "bardzo rzadko", "rzadko", "czasami", "często", "bardzo często", "zawsze"), fill = c("yellow", "limegreen", "royalblue3", "purple", "mediumvioletred", "maroon1", "seashell1"))
```
...
```{r}
tab <- table(dane$dobry_humor, dane$jakosc_posilkow) 
tab #Tabela kontyngencji
barplot(tab,
        main="Jak dużą uwagę przykładasz do jakości swoich posiłków?",
        ylab="Rozkład aktualnego humoru",
        col = c("yellow", "limegreen", "royalblue3", "purple", "mediumvioletred"),
        names.arg = c("żadną", "małą", "średnią", "dużą", "bardzo dużą"),
        legend.text = c("zły", "kiepski", "średni", "dobry", "b. dobry"))
ttab <- prop.table(tab, margin = 2)*100
ttab # w procentach
barplot(ttab,
        main = "Jak dużą uwagę przykładasz do jakości swoich posiłków?",
