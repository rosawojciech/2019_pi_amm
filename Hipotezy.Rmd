...
### Zależność pomiędzy poczuciem upokorzenia a jakością snu
```{r}
...
### Wykresy boxplot
```{r}
#wydaje mi się, że te boxploty nic tak naprawdę nie mówią i są nieczytelne
#par(mfrow=c(1,2))
...
### Zależność pomiędzy dietą a poczuciem radości
```{r}
...
### Wykresy barplot
```{r}
tab <- table(dane$radosc, dane$dieta) 
tab #Tabela kontyngencji
barplot(tab,  main = "Częstość odczuwania radości, w zależności od rodzaju diety", xlab="Rodzaj diety", ylab="Rozkład poczucia radości", col=c("lightyellow3", "antiquewhite1", "cyan3", "chartreuse", "darkorange1", "firebrick1", "darkorchid3"), legend.text = c("nigdy", "b. rzadko", "rzadko", "czasami", "często", "b. często", "zawsze"), names.arg = c("fast food", "żywność przetw.", "mięso", "wegetariańska", "zbilans."))
ttab <- prop.table(tab, margin = 2)*100
ttab # w procentach
barplot(ttab, main = "Częstość odczuwania radości, w zależności od rodzaju diety", xlab="Rodzaj diety", ylab="Procentowy rozkład poczucia radości", col=c("lightyellow3", "antiquewhite1", "cyan3", "chartreuse", "darkorange1", "firebrick1", "darkorchid3"), legend.text = c("nigdy", "b. rzadko", "rzadko", "czasami", "często", "b. często", "zawsze"), names.arg = c("fast food", "żywność przetw.", "mięso","wegetariańska", "zbilans."))
```

### Zależność pomiędzy liczbą bliskich znajomych a odczuwaniem niepokoju
...
P-value dla testu `rho-Spearmana` wynosi `r r5`, natomiast dla testu `tau-Kendalla` wynosi `r r6`. Należy odrzucić hipotezę $H_0$, na rzecz hipotezy alternatywnej $H_1$. Istnieje zależność pomiędzy liczbą osób, z którymi utrzymuje się regularny kontakt a odczuwaniem niepokoju.

```{r}
tab <- table(dane$niepokoj, dane$liczba_osob_kontakty) 
tab #Tabela kontyngencji
barplot(tab,
        main = "Odczuwanie niepokoju, w zależności od liczby bliskich znajomych",
        xlab="Liczba osób, z którymi utrzymuje się regularny kontakt", ylab="Rozkład poczucia niepokoju",
        col=c("lightyellow3", "antiquewhite1", "cyan3", "chartreuse", "darkorange1", "firebrick1", "darkorchid3"),
        legend.text = c("nigdy", "b. rzadko", "rzadko", "czasami", "często", "b. często", "zawsze"),
