...
P-value dla testu `rho-Spearmana` wynosi `r sprintf("%.10f", r1)`, natomiast dla testu `tau-Kendalla` wynosi `r sprintf("%.10f", r2)`. Nie ma podstaw do odrzucenia hipotezy $H_0$, a więc nie istnieje zależność pomiędzy poczuciem upokorzenia a jakością snu.
...
P-value dla testu `rho-Spearmana` wynosi `r sprintf("%.10f", r3)`, natomiast dla testu `tau-Kendalla` wynosi `r sprintf("%.10f", r4)`. Nie ma podstaw do odrzucenia $H_0$. Nie istnieje zależność pomiędzy dietą a poczuciem radości.
...
### Zależność pomiędzy posiadaniem wyznaczonych pór snu a jego jakością
...
```{r}
tab <- table(dane$jakosc_snu, dane$wyzn_pory_snu) 
tab #Tabela kontyngencji
barplot(tab,
        main="Czy masz wyznaczone pory snu?",
        ylab="Rozkład jakości snu",
        col = c("yellow", "limegreen", "royalblue3", "purple", "mediumvioletred", "maroon1", "seashell1"),
        names.arg = c("nie", "raczej nie", "czasami", "raczej tak", "tak"),
        legend.text = c("bardzo zła", "kiepska", "przeciętna", "dobra", "b. dobra"))
ttab <- prop.table(tab, margin = 2)*100
ttab # w procentach
barplot(ttab,
        main = "Czy masz wyznaczone pory snu?",
...
### Zależność pomiędzy liczbą godzin przeznaczonych na uprawianie sportu a odczuwaniem załamania
...
```{r}
tab <- table(dane$zalamanie, dane$godziny_sportu) 
tab #Tabela kontyngencji
barplot(tab,
        main="Wykres zależności",
        xlab="Liczba godzin w tygodniu przeznaczonych na sport",
        ylab="Rozkład poczucia załamania",
        col = c("yellow", "limegreen", "royalblue3", "purple", "mediumvioletred", "maroon1", "seashell1"),
