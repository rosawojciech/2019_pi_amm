...
barplot(tab,
        xlab="Jakość snu",
        ylab="Rozkład poczucia upokorzenia",
        col = c("yellow", "limegreen", "royalblue3", "purple", "mediumvioletred", "maroon1", "seashell1"),
        names.arg = c("bardzo zła", "kiepska", "przeciętna", "dobra", "bardzo dobra"),
        legend.text = c("nigdy", "bardzo rzadko", "rzadko", "czasami", "często", "bardzo często", "zawsze"))
ttab <- prop.table(tab, margin = 2)*100
ttab # w procentach
barplot(ttab,
        main = "Częstość odczuwania upokorzenia w zależności od jakości snu", xlab="Jakość snu",
...
tab #Tabela kontyngencji
barplot(tab,
        main = "Częstość odczuwania radości, w zależności od rodzaju diety",
        xlab="Rodzaj diety",
        ylab="Rozkład poczucia radości",
        ...
        names.arg = c("fast food", "żywność przetw.", "mięso", "wegetariańska", "zbilans."))
ttab <- prop.table(tab, margin = 2)*100
ttab # w procentach
barplot(ttab,
        main = "Częstość odczuwania radości, w zależności od rodzaju diety",
...
barplot(tab,
        ...
        ylab="Rozkład poczucia niepokoju",
        col=c("lightyellow3", "antiquewhite1", "cyan3", "chartreuse", "darkorange1", "firebrick1", "darkorchid3"),
        legend.text = c("nigdy", "b. rzadko", "rzadko", "czasami", "często", "b. często", "zawsze"),
...
### Zależność pomiędzy liczbą godzin przeznaczonych na korzystanie z urządzeń elektronicznych a poczuciem uzależnienia od urządzeń
...
P-value dla testu `rho-Spearmana` wynosi `r r7`, natomiast dla testu `tau-Kendalla` wynosi `r r8`. Należy odrzucić hipotezę $H_0$, na rzecz hipotezy alternatywnej $H_1$. Istnieje zależność pomiędzy liczbą godzin spędzonych na używaniu urządzeń elektronicznych a poczuciem uzależnienia od nich.

```{r}
tab <- table(dane$poczucie_uzaleznienia_urzadzenia, dane$godziny_rozrywki_urzadzenia) 
tab #Tabela kontyngencji
barplot(tab,
        main = "Wykres zależności",
        xlab="Liczba godzin spędzonych na komputerze w celach rozrywkowych",
        ylab="Rozkład poczucia uzależnienia od urządzeń",
        col=c("lightyellow3", "antiquewhite1", "cyan3", "chartreuse", "darkorange1", "firebrick1", "darkorchid3"),
        legend.text = c("nigdy", "b. rzadko", "rzadko", "czasami", "często", "b. często", "zawsze"),
